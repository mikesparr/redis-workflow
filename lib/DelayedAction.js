...
var DelayedAction = (function (_super) {
    ...
    function DelayedAction(name, intervalAsMillis, context, delayAsTimestamp, repeat) {
        var _this = this;
        ...
        _this.recurrences = repeat ? 0 : 1;
        _this.interval = intervalAsMillis ? intervalAsMillis : 0;
        if (delayAsTimestamp) {
            _this.scheduledAt = delayAsTimestamp;
        }
        return _this;
    }
    ...
    DelayedAction.prototype.addContext = function (obj) {
    ...
    DelayedAction.prototype.setDelayFrom = function (timestamp) {
